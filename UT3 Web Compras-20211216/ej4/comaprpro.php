...
<body>
  <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
    ...
    <p>Cantidad de producto a aprovisionar:</p>
    <input type='text' name='cantidad' placeholder='Cantidad de producto a aprovisionar'>
...
if (isset($_POST['enviar'])) {
  ...
  //FUNCIONES
  revisarparametros($cantidad,$producto,$almacen);
  altaalmacen($cantidad,$producto,$almacen,$conexion);
